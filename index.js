...
const API_KEY = "live_Wnqd2JV4EMaQONaRroewu3pOgt2fHrYV38wu3pUObF4rzzClPL5jtTJnswXRX5cH";
...
async function initialLoad (){
  ...
  //const breedsId = []; 
  const response = await axios.get(`https://api.thecatapi.com/v1/images/search?limit=10&has_breeds=1&api_key=${API_KEY}`, {onDownloadProgress: updateProgress});
...
async function getCatz(y){
   const cats = [];
  //console.log(y);
     const response = await axios.get(`https://api.thecatapi.com/v1/images/search?limit=10&has_breeds=1&breed_ids=${y}&api_key=${API_KEY}`, {onDownloadProgress: updateProgress});
     //const jsonData = await response.json();
